...
// basicAuth returns a middleware that enforces HTTP Basic Authentication when
// cfg.Username and cfg.PasswordHash are both non-empty.
// If either field is empty, the middleware is a no-op and every request passes through.
